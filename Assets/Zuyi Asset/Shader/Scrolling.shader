Shader "Custom/Scrolling" {
	Properties { _Color ("Main Color", Color) = (1,1,1,1) _MainTex ("Base (RGB) Trans (A)", 2D) = "white" {} _AlphaMap ("Additional Alpha Map (Greyscale)", 2D) = "white" {} }
...
sampler2D _MainTex; sampler2D _AlphaMap; float4 _Color;
